...
/* education/edit.html.twig */
class __TwigTemplate_346837626434183dc576d64aecddd7532a97186fe0f28d05e6f8183857e76c2c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "education/edit.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "education/edit.html.twig"));
    ...
    <div class=\"modal-content\">
        <div class=\"modal-body\">
            ...
            <div class=\"content\">
                ";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), 'form_start', ["action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("education_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["education"]) || array_key_exists("education", $context) ? $context["education"] : (function () { throw new RuntimeError('Variable "education" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8)]), "attr" => ["id" => ("editEduForm" . twig_get_attribute($this->env, $this->source, (isset($context["education"]) || array_key_exists("education", $context) ? $context["education"] : (function () { throw new RuntimeError('Variable "education" does not exist.', 8, $this->source); })()), "id", [], "any", false, false, false, 8))]]);
        echo "
...
<script>
    \$(document).on(\"submit\",\"#editEduForm\".concat(\"";
        // line 83
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["education"]) || array_key_exists("education", $context) ? $context["education"] : (function () { throw new RuntimeError('Variable "education" does not exist.', 83, $this->source); })()), "id", [], "any", false, false, false, 83), "html", null, true);
        echo "\"),function(event) {
        event.preventDefault();
        event.stopImmediatePropagation();
        \$form = \$(\"#editEduForm\".concat(\"";
        // line 86
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["education"]) || array_key_exists("education", $context) ? $context["education"] : (function () { throw new RuntimeError('Variable "education" does not exist.', 86, $this->source); })()), "id", [], "any", false, false, false, 86), "html", null, true);
        echo "\"));
        \$.ajax({
        ...
        // line 95
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["education"]) || array_key_exists("education", $context) ? $context["education"] : (function () { throw new RuntimeError('Variable "education" does not exist.', 95, $this->source); })()), "id", [], "any", false, false, false, 95), "html", null, true);
        echo "\").html(data);
                    feather.replace();
                }
...
";
    ...
    {
        return "education/edit.html.twig";
    }
    ...
    <div class=\"modal-content\">
        <div class=\"modal-body\">
            ...
            <div class=\"content\">
                {{form_start(form,{'action':path('education_edit',{'id':education.id}),'attr':{'id':'editEduForm'~education.id}})}}
                    <div class=\"input-block-wrap\">
                            <div class=\"form-group row\">
                                <label class=\"col-sm-3 col-form-label\" style=\"margin-right: 0; padding-top: 10px; padding-bottom: 0; color: #6f7484;font-size: 1.4rem; font-family: 'Poppins', sans-serif; font-weight: 600\">
                                Information About Degree
                            ...
                            <div class=\"form-group row\">
                                <div class=\"offset-sm-3 col-sm-9\">
                                    <div class=\"input-group\">
                                        ...
                                        {{ form_errors(form.InstitutionName) }}
                                    </div>
                                </div>
                            </div>
                            <div class=\"form-group row\">
...
<script>
    \$(document).on(\"submit\",\"#editEduForm\".concat(\"{{ education.id }}\"),function(event) {
        event.preventDefault();
        event.stopImmediatePropagation();
        \$form = \$(\"#editEduForm\".concat(\"{{ education.id }}\"));
        \$.ajax({
            url: \$form.attr(\"action\"),
            type: \"POST\",
            data: \$form.serialize(),
            success: function (data) {
                ...
                if(data === \"success\") window.location.reload();
                    ...
                    \$(\"#modal-education-edit-{{ education.id }}\").html(data);
                    feather.replace();
                }
...
", "education/edit.html.twig", "C:\\Users\\Win10-Space\\Desktop\\tunrecrute\\final\\templates\\education\\edit.html.twig");
    }
}
